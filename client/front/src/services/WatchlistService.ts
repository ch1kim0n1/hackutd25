...
import type { Watchlist, CreateWatchlistRequest } from "./alpaca.types";
...
export class WatchlistService extends AlpacaClient {
  ...
  async addSymbolToWatchlist(
    ...
    return this.request<Watchlist>("POST", `/v2/watchlists/${watchlistId}`, {
      symbol,
    });
  }
